...
FalknerGroup:
	...
	db  6, ZUBAT, 		GUST, CONFUSE_RAY, NO_MOVE, NO_MOVE
	db  7, HOOTHOOT,     	TACKLE, MUD_SLAP, GROWL, FORESIGHT
	db  10, NATU,  		PECK, NIGHT_SHADE, LEER, MUD_SLAP
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 15, TEDDIURSA,  SCRATCH, LICK, MUD_SLAP, ICE_PUNCH, NO_MOVE
	db 18, FURRET,     HEADBUTT, DEFENSE_CURL, QUICK_ATTACK, SHADOW_BALL
...
BugsyGroup:
	...
	db 14, PINECO,     SWIFT, SPIKES, REFLECT, PIN_MISSILE
	db 14, YANMA,      SWIFT, GIGA_DRAIN, DOUBLE_TEAM, TOXIC
	db 16, SCYTHER,    QUICK_ATTACK, LEER, PURSUIT, CUT
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, THUNDER, THIEF, SHADOW_BALL
	db 23, HAUNTER,    CURSE, MEAN_LOOK, THUNDER, THIEF
	db 24, MISDREAVUS, SHADOW_BALL, THUNDERBOLT, HYPNOSIS, PSYCHIC_M
	db 25, GENGAR,     HYPNOSIS, DREAM_EATER, THUNDERBOLT, ICE_PUNCH
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 27, SNEASEL,    DYNAMICPUNCH, HEADBUTT, SCREECH, MOONLIGHT
	db 29, DEWGONG,    ICY_WIND, BUBBLEBEAM, ICE_BEAM, SURF
	db 30, JYNX,       LOVELY_KISS, ICE_BEAM, PSYCHIC_M, THIEF
	db 32, CLOYSTER,   SURF, ICE_BEAM, BLIZZARD, NO_MOVE
	db 32, LAPRAS, 	   ICE_BEAM, SURF, THUNDERBOLT, SING
	db 35, PILOSWINE,  EARTHQUAKE, ANCIENTPOWER, ICE_BEAM, BODY_SLAM
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 28, FORRETRESS, SPIKES, TOXIC, DOUBLE_TEAM, PROTECT
	db 30, SKARMORY,   FLY, DOUBLE_TEAM, TOXIC, REST
	db 30, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, SUPERSONIC, SWAGGER
	db 32, STEELIX,    CURSE, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db 32, SCIZOR, 	   CUT, FLY, QUICK_ATTACK, LIGHT_SCREEN
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 26, PRIMEAPE,   STRENGTH, ROCK_SLIDE, BODY_SLAM, THIEF
	db 27, HERACROSS,  FURY_CUTTER, HORN_ATTACK, THIEF, HEADBUTT
	db 28, HITMONTOP,  STRENGTH, COUNTER, PURSUIT, QUICK_ATTACK
	db 30, POLIWRATH,  HYPNOSIS, ICE_BEAM, SURF, STRENGTH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, ICE_BEAM, THUNDERBOLT
	db 38, DRAGONITE,  FLY, EARTHQUAKE, STRENGTH, ICE_BEAM
	db 38, DRAGONITE,  FLY, EARTHQUAKE, STRENGTH, RECOVER
	db 38, GYARADOS,   SURF, DRAGONBREATH, THUNDER, HYPER_BEAM
	db 38, DRAGONITE,  FLY, EARTHQUAKE, THUNDER, BLIZZARD
	db 40, KINGDRA,    DOUBLE_TEAM, SURF, ICE_BEAM, REST
	db -1 ; end
...
Rival1Group:
	...
	db 20, ZUBAT,      RECOVER, GUST, BITE, CONFUSE_RAY
	...
	; RIVAL1 (11)
	db "?@", TRAINERTYPE_MOVES
	db 30, CROBAT,     FLY, SLUDGE_BOMB, CONFUSE_RAY, RECOVER
	db 28, MAGNETON,   SWIFT, THUNDERBOLT, SUPERSONIC, THUNDER_WAVE
	db 30, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 32, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 32, QUILAVA,    SMOKESCREEN, DIG, QUICK_ATTACK, FIRE_BLAST
	db -1 ; end
	...
	db 30, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 32, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 32, FERALIGATR, SURF, BLIZZARD, DIG, ROCK_SLIDE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 38, ALAKAZAM,   PSYCHIC_M, THUNDERPUNCH, ICE_PUNCH, RECOVER
	db 39, CROBAT,     FLY, SLUDGE_BOMB, CONFUSE_RAY, RECOVER
	db 38, MAGNETON,   TRI_ATTACK, THUNDERBOLT, SUPERSONIC, THUNDER_WAVE
	db 39, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 37, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 38, MEGANIUM,   EARTHQUAKE, RAZOR_LEAF, SWORDS_DANCE, BODY_SLAM
	db -1 ; end
	...
	db 39, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 37, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 38, TYPHLOSION, FIRE_BLAST, EARTHQUAKE, THUNDERPUNCH, STRENGTH
	db -1 ; end
	...
	db 39, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 37, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 38, FERALIGATR, HYDRO_PUMP, BLIZZARD, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
...
WillGroup:
	...
	db 40, STARMIE,    PSYCHIC_M, SURF, THUNDER, RECOVER
	db 41, JYNX,       THIEF, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 41, EXEGGUTOR,  SPORE, PSYCHIC_M, GIGA_DRAIN, EXPLOSION
	db 41, SLOWBRO,    PSYCHIC_M, SURF, REST, SLEEP_TALK
	db 42, GIRAFARIG,  PSYCHIC_M, THUNDER, EARTHQUAKE, HEADBUTT
	db 43, ALAKAZAM,   PSYCHIC_M, DYNAMICPUNCH, BARRIER, RECOVER
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONTOP,  STRENGTH, HIDDEN_POWER, COUNTER, MACH_PUNCH
	db 42, HITMONLEE,  MEDITATE, HIDDEN_POWER, HI_JUMP_KICK, BODY_SLAM
	db 42, HERACROSS,  MEGAHORN, STRENGTH, EARTHQUAKE, HEADBUTT
	db 43, STEELIX,    EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, EXPLOSION
	db 46, POLIWRATH,  HYPNOSIS, SURF, ICE_BEAM, STRENGTH
	db 46, MACHAMP,    ROCK_SLIDE, HIDDEN_POWER, EARTHQUAKE, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 45, GENGAR,     THUNDER, ICE_PUNCH, DYNAMICPUNCH, DESTINY_BOND
	db 42, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 44, MISDREAVUS, PSYCHIC_M, THUNDER, HYPNOSIS, DESTINY_BOND
	db 45, MAROWAK,    EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST, SWORDS_DANCE
	db 47, HOUNDOOM,   SUNNY_DAY, SOLARBEAM, FIRE_BLAST, CRUNCH
	db 47, TYRANITAR,  ROCK_SLIDE, EARTHQUAKE, THUNDERBOLT, STRENGTH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 40, NIDOKING,   LOVELY_KISS, EARTHQUAKE, ICE_BEAM, THUNDER
	db 43, TENTACRUEL, SURF, SLUDGE_BOMB, ICE_BEAM, BARRIER
	db 43, WEEZING,    SLUDGE_BOMB, FIRE_BLAST, THUNDER, DESTINY_BOND
	db 42, MUK,        MINIMIZE, GIGA_DRAIN, SLUDGE_BOMB, FIRE_BLAST
	db 44, CROBAT,     DOUBLE_TEAM, SLUDGE_BOMB, FLY, TOXIC
	db 45, NIDOQUEEN,  EARTHQUAKE, MOONLIGHT, ICE_BEAM, THUNDER
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 44, KINGDRA,    SURF, ICE_BEAM, REST, SLEEP_TALK
	db 47, GYARADOS,   HYDRO_PUMP, THUNDER, HYPER_BEAM, NO_MOVE
	db 47, DRAGONITE,  THUNDER_WAVE, THUNDER, DYNAMICPUNCH, BLIZZARD
	db 46, AERODACTYL, FLY, ANCIENTPOWER, EARTHQUAKE, FIRE_BLAST
	db 46, CHARIZARD,  FIRE_BLAST, EARTHQUAKE, ROCK_SLIDE, SWORDS_DANCE
	db 50, DRAGONITE,  FLY, EARTHQUAKE, STRENGTH, ICE_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 62, GOLEM,      DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 63, RHYDON,     STRENGTH, ROCK_SLIDE, EARTHQUAKE, BLIZZARD
	db 62, OMASTAR,    BITE, SURF, ANCIENTPOWER, ICE_BEAM
	db 64, STEELIX,    EARTHQUAKE, ROCK_SLIDE, IRON_TAIL, SANDSTORM
	db 62, KABUTOPS,   SLASH, SURF, ROCK_SLIDE, GIGA_DRAIN
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 54, LANTURN,    THUNDERBOLT, SURF, ICE_BEAM, THUNDER_WAVE
	db 55, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, REST
	db 55, LAPRAS,     SURF, THUNDER, BLIZZARD, MOONLIGHT
	db 57, STARMIE,    SURF, THUNDER, RECOVER, ICE_BEAM
	db 57, VAPOREON,   SURF, ICE_BEAM, BLIZZARD, RECOVER
	dB 58, SLOWBRO,    SURF, PSYCHIC_M, ICE_BEAM, FLAMETHROWER
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 51, RAICHU,     THUNDER_WAVE, SURF, DYNAMICPUNCH, THUNDER
	db 51, ELECTRODE,  SCREECH, THUNDER, THUNDER_WAVE, EXPLOSION
	db 52, MAGNETON,   THUNDER, TRI_ATTACK, THUNDER_WAVE, NO_MOVE
	db 54, ELECTABUZZ, THUNDER, CROSS_CHOP, ICE_PUNCH, PSYCHIC_M
	db 55, AMPHAROS,   THUNDER, THUNDER_WAVE, FIRE_PUNCH, DYNAMICPUNCH
	db 56, ZAPDOS,     THUNDER, DRILL_PECK, THUNDER_WAVE, REFLECT
	db -1 ; end
...
ErikaGroup:
	...
	db 62, TANGELA,    GIGA_DRAIN, SLEEP_POWDER, TOXIC, PROTECT
	db 61, JUMPLUFF,   SLEEP_POWDER, LEECH_SEED, FLY, GIGA_DRAIN
	db 66, VICTREEBEL, SLEEP_POWDER, SWORDS_DANCE, SLUDGE_BOMB, GIGA_DRAIN
	db 66, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db 66, VENUSAUR, SLEEP_POWDER, SWORDS_DANCE, SLUDGE_BOMB, GIGA_DRAIN
	db -1 ; end
...
JanineGroup:
	...
	db 66, CROBAT,     SCREECH, SLUDGE_BOMB, CONFUSE_RAY, FLY
	db 66, WEEZING,    FIRE_BLAST, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 66, WEEZING,    FIRE_BLAST, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 63, ARIADOS,    SCARY_FACE, GIGA_DRAIN, SLUDGE_BOMB, BATON_PASS
	db 69, VENOMOTH,   SLEEP_POWDER, DOUBLE_TEAM, TOXIC, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	db 66, ESPEON,     MUD_SLAP, MORNING_SUN, SWIFT, PSYCHIC_M
	db 66, MR__MIME,   BARRIER, THUNDER, BATON_PASS, PSYCHIC_M
	db 68, ALAKAZAM,   RECOVER, DYNAMICPUNCH, PSYCHIC_M, BARRIER
	db -1 ; end
...
BlaineGroup:
	...
	db 68, ARCANINE,   IRON_TAIL, CRUNCH, FIRE_BLAST, DIG
	db 69, CHARIZARD,  FIRE_BLAST, EARTHQUAKE, ROCK_SLIDE, SWORDS_DANCE
	db 65, ENTEI,      FIRE_BLAST, SUNNY_DAY, SOLARBEAM, IRON_TAIL
	db 65, MAGMAR,     THUNDERPUNCH, FIRE_BLAST, SUNNY_DAY, CONFUSE_RAY
	db 67, RAPIDASH,   SUNNY_DAY, DOUBLE_EDGE, STOMP, FIRE_BLAST
	db 67, NINETALES,  FLAMETHROWER, CONFUSE_RAY, SUBSTITUTE, SOLARBEAM
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, HOUNDOOM,   FIRE_BLAST, SOLARBEAM, BITE, FAINT_ATTACK
	db 33, WEEZING,    THUNDER, SLUDGE_BOMB, SMOKESCREEN, EXPLOSION
	db 35, HOUNDOOM,   FIRE_BLAST, SOLARBEAM, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 36, CROBAT,     RECOVER, BITE, CONFUSE_RAY, FLY
	db -1 ; end
...
RedGroup:
	...
	db 100,SNORLAX,    DOUBLE_EDGE, EARTHQUAKE, CURSE, REST
	db 100,MEWTWO,     PSYCHIC_M, EARTHQUAKE, AMNESIA, RECOVER
	db 100,ZAPDOS,     THUNDER, DRILL_PECK, REFLECT, RECOVER
	db 100,HO_OH,      SACRED_FIRE, GIGA_DRAIN, EARTHQUAKE, RECOVER
	db 100,TYRANITAR,  ROCK_SLIDE, SURF, THUNDERBOLT, CRUNCH
	dB 100,SUICUNE,    SURF, BLIZZARD, REST, SLEEP_TALK
	db 100,DRAGONITE,  FLY, EARTHQUAKE, STRENGTH, BLIZZARD
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 70, LUGIA,      FLY, EARTHQUAKE, SURF, RECOVER
	db 70, ALAKAZAM,   DYNAMICPUNCH, RECOVER, PSYCHIC_M, REFLECT
	db 70, RHYDON,     CURSE, REST, ROCK_SLIDE, EARTHQUAKE
	db 72, STARMIE,    SURF, PSYCHIC_M, THUNDER, RECOVER
	db 73, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 75, ARCANINE,   IRON_TAIL, CRUNCH, FIRE_BLAST, DIG
	db -1 ; end
