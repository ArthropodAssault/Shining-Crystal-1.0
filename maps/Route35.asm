...
JugglerIrwin1SeenText:
	...
	text "I've been"
	line "diversifying my"
        cont "team."

	text "But I still love" 
	line "voltorb."
	done
...
Route35_MapEvents:
	...
	object_event 13, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route35TMTHIEF, EVENT_ROUTE_35_TM_THIEF
