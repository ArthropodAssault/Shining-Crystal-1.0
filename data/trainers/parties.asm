...
FalknerGroup:
	...
	db  9, GLIGAR,     	ROOST, SAND_ATTACK, SWIFT, POISON_STING
	db  9, DELIBIRD,	ICY_WIND, QUICK_ATTACK, ROOST, NO_MOVE
	db  9, ZUBAT,           GUST, CONFUSE_RAY, ROOST, NO_MOVE
...
WhitneyGroup:
	...
	db 20, STANTLER,   HEADBUTT, CURSE, HYPNOSIS, EARTHQUAKE
	db 18, DUNSPARCE,  HEADBUTT, ROLLOUT, GLARE, DEFENSE_CURL
	db 20, TOGETIC,    FIRE_BLAST, HEADBUTT, STEEL_WING, ROOST
	db 19, GIRAFARIG,  HEADBUTT, THUNDER, CONFUSION, IRON_TAIL
...
BugsyGroup:
	...
	db 15, BUTTERFREE, SLEEP_POWDER, CONFUSION, STUN_SPORE, TACKLE
	db 14, FORRETRESS, HEADBUTT, GIGA_DRAIN, PROTECT, HIDDEN_POWER
	db 14, YANMA,      SWIFT, GIGA_DRAIN, DOUBLE_TEAM, QUICK_ATTACK
	db 15, LEDYBA,     TACKLE, COMET_PUNCH, SUPERSONIC, PSYBEAM
	db 16, ARIADOS,    SLUDGE, NIGHT_SHADE, TOXIC, DIG
	db -1 ; end
...
MortyGroup:
	...
	db 24, MISDREAVUS, PAIN_SPLIT, THUNDER, HYPNOSIS, PSYCHIC_M
	db 24, MISDREAVUS, DESTINY_BOND, THUNDER, HYPNOSIS, PSYCHIC_M
	db 25, GENGAR,     HYPNOSIS, FIRE_PUNCH, THUNDER, ICE_PUNCH
	db 25, GENGAR,     HYPNOSIS, DESTINY_BOND, THUNDER, ICE_PUNCH
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 34, SNEASEL,    DYNAMICPUNCH, RETURN, SCREECH, BLIZZARD
	db 32, DEWGONG,    REST, SLEEP_TALK, BLIZZARD, SURF
	db 34, JYNX,       LOVELY_KISS, BLIZZARD, PSYCHIC_M, THIEF
	db 33, CLOYSTER,   SURF, SCREECH, BLIZZARD, DOUBLE_EDGE
	db 35, PILOSWINE,  EARTHQUAKE, ANCIENTPOWER, BLIZZARD, STRENGTH
	db 35, LAPRAS, 	   BLIZZARD, SURF, THUNDER, SING
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 32, SCIZOR, 	   LEECH_LIFE, FLY, STRENGTH, METAL_CLAW
	db 30, SKARMORY,   FLY, DOUBLE_TEAM, TOXIC, ROOST
	db 30, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, PSYCHIC_M, SWAGGER
	db 32, STEELIX,    CURSE, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db 32, SCIZOR, 	   LEECH_LIFE, ROCK_SMASH, STRENGTH, METAL_CLAW
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 26, DONPHAN,    MAGNITUDE, ROCK_SLIDE, FLAIL, NO_MOVE
	db 29, SUDOWOODO,  ROCK_SMASH, ROLLOUT, DYNAMICPUNCH, DIG
	db 28, HITMONTOP,  STRENGTH, COUNTER, PURSUIT, QUICK_ATTACK
	db 30, URSARING,   BODY_SLAM, EARTHQUAKE, ICE_PUNCH, FIRE_PUNCH
	db 30, HERACROSS,  ROCK_SMASH, STRENGTH, COUNTER, SLASH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 38, DRAGONITE,  FLY, EARTHQUAKE, STRENGTH, BLIZZARD
	db 40, EXEGGUTOR,  PSYCHIC_M, GIGA_DRAIN, SLEEP_POWDER, SLUDGE_BOMB
	db 38, GYARADOS,   SURF, FLY, THUNDER, EARTHQUAKE
	db 38, DRAGONITE,  FLY, EARTHQUAKE, STRENGTH, BLIZZARD
	db 39, AMPHAROS,   THUNDER, ICE_PUNCH, REST, SLEEP_TALK
	db 40, KINGDRA,    HYDRO_PUMP, BLIZZARD, REST, SLEEP_TALK
	db -1 ; end
...
Rival1Group:
	...
	db 18, ELEKID,     SWIFT, THUNDERPUNCH, QUICK_ATTACK, CROSS_CHOP
	db 20, GOLBAT,     ROOST, GUST, BITE, CONFUSE_RAY
	db 22, CROCONAW,   DIG, RAGE, SURF, BITE
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, CROBAT,     FLY, SLUDGE_BOMB, CONFUSE_RAY, ROOST
	db 31, ELECTABUZZ, ICE_PUNCH, THUNDER, QUICK_ATTACK, CROSS_CHOP
	db 30, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 32, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 36, MEGANIUM,   REFLECT, GIGA_DRAIN, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 32, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 36, FERALIGATR, SURF, BLIZZARD, DIG, ROCK_SLIDE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 43, ALAKAZAM,   PSYCHIC_M, DYNAMICPUNCH, ICE_PUNCH, FIRE_PUNCH
	db 41, CROBAT,     FLY, SLUDGE_BOMB, GIGA_DRAIN, LEECH_LIFE
	db 42, ELECTABUZZ, ICE_PUNCH, THUNDER, CROSS_CHOP, PURSUIT
	db 41, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 40, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 43, MEGANIUM,   EARTHQUAKE, GIGA_DRAIN, SWORDS_DANCE, BODY_SLAM
	db -1 ; end
	...
	db 41, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 40, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 43, TYPHLOSION, FIRE_BLAST, EARTHQUAKE, THUNDERPUNCH, STRENGTH
	db -1 ; end
	...
	db 41, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 40, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 43, FERALIGATR, HYDRO_PUMP, BLIZZARD, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
...
WillGroup:
	...
	db 49, JYNX,       THIEF, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 48, ESPEON,     PSYCHIC_M, CRUNCH, HIDDEN_POWER, GROWTH
	db 48, EXEGGUTOR,  SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, ANCIENTPOWER
	db 49, SLOWKING,    PSYCHIC_M, SURF, REST, SLEEP_TALK
	db 47, GIRAFARIG,  PSYCHIC_M, THUNDER, EARTHQUAKE, HEADBUTT
	db 50, ALAKAZAM,   PSYCHIC_M, DYNAMICPUNCH, FIRE_PUNCH, RECOVER
	db -1 ; end
...
PKMNTrainerGroup:
	...
	db 67, FERALIGATR,  LEFTOVERS,	CURSE, EARTHQUAKE, ROCK_SLIDE, HYDRO_PUMP
	db 65, VENUSAUR,    LEFTOVERS,	GROWTH, GIGA_DRAIN, HIDDEN_POWER, LIGHT_SCREEN
	db 66, BLASTOISE,   LEFTOVERS,	HYDRO_PUMP, BLIZZARD, EARTHQUAKE, BODY_SLAM
...
BrunoGroup:
	...
	db 46, HITMONTOP,  STRENGTH, HIDDEN_POWER, COUNTER, ROCK_SMASH
	db 47, SUDOWOODO,  ROCK_SLIDE, EARTHQUAKE, THUNDERPUNCH, ICE_PUNCH
	db 48, HERACROSS,  MEGAHORN, STRENGTH, EARTHQUAKE, ROCK_SMASH
	db 49, STEELIX,    EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, BODY_SLAM
	db 49, QUAGSIRE,   EARTHQUAKE, BLIZZARD, BELLY_DRUM, RECOVER
	db 50, MACHAMP,    ROCK_SLIDE, HIDDEN_POWER, EARTHQUAKE, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 48, GENGAR,     NO_ITEM,	       THUNDER, ICE_PUNCH, DYNAMICPUNCH, DESTINY_BOND
	db 47, UMBREON,    LEFTOVERS,	       TOXIC, CHARM, PURSUIT, DOUBLE_TEAM
	db 48, MISDREAVUS, NO_ITEM,	       PSYCHIC_M, THUNDER, HYPNOSIS, DESTINY_BOND
	db 49, MAROWAK,    THICK_CLUB, 	       EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST, SWORDS_DANCE
	db 50, HOUNDOOM,   NO_ITEM,	       STRENGTH, HIDDEN_POWER, FIRE_BLAST, CRUNCH
	db 50, TYRANITAR,  NO_ITEM,	       ROCK_SLIDE, EARTHQUAKE, THUNDERBOLT, STRENGTH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 46, NIDOKING,   LOVELY_KISS, EARTHQUAKE, BLIZZARD, THUNDER
	db 47, TENTACRUEL, SURF, SLUDGE_BOMB, ICE_BEAM, GIGA_DRAIN
	db 47, WEEZING,    SLUDGE_BOMB, FIRE_BLAST, THUNDER, DESTINY_BOND
	db 48, MUK,        MINIMIZE, GIGA_DRAIN, SLUDGE_BOMB, FIRE_BLAST
	db 48, CROBAT,     GIGA_DRAIN, SLUDGE_BOMB, FLY, LEECH_LIFE
	db 50, NIDOQUEEN,  EARTHQUAKE, LOVELY_KISS, BLIZZARD, THUNDER
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 48, KINGDRA,    LEFTOVERS, 	HYDRO_PUMP, DRAGONBREATH, BLIZZARD, BODY_SLAM
	db 47, GYARADOS,   SHARP_BEAK,	HYDRO_PUMP, THUNDER, EARTHQUAKE, FLY
	db 47, DRAGONITE,  SHARP_BEAK,	FLY, EARTHQUAKE, DYNAMICPUNCH, BLIZZARD
	db 48, AERODACTYL, SHARP_BEAK,	FLY, ANCIENTPOWER, EARTHQUAKE, FIRE_BLAST
	db 48, CHARIZARD,  CHARCOAL,	FIRE_BLAST, EARTHQUAKE, ROCK_SLIDE, FLY
	db 50, DRAGONITE,  SHARP_BEAK,	FLY, EARTHQUAKE, STRENGTH, BLIZZARD
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 68, KABUTOPS,   SWORDS_DANCE, SURF, ROCK_SMASH, BLIZZARD
	db 68, GOLEM,      EXPLOSION, ROCK_SLIDE, STRENGTH, EARTHQUAKE
	db 66, RHYDON,     STRENGTH, ROCK_SLIDE, EARTHQUAKE, BLIZZARD
	db 67, OMASTAR,    REST, HYDRO_PUMP, ANCIENTPOWER, BLIZZARD
	db 69, STEELIX,    EARTHQUAKE, ROCK_SLIDE, IRON_TAIL, EXPLOSION
	db 72, TYRANITAR,  ROCK_SLIDE, EARTHQUAKE, THUNDERBOLT, STRENGTH
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 55, LANTURN,    SCOPE_LENS, THUNDER, HYDRO_PUMP, BLIZZARD, RECOVER
	db 55, QUAGSIRE,   SCOPE_LENS, HYDRO_PUMP, BELLY_DRUM, EARTHQUAKE, RECOVER
	db 56, LAPRAS,     SCOPE_LENS, HYDRO_PUMP, THUNDER, BLIZZARD, MOONLIGHT
	db 57, LUGIA,      SCOPE_LENS, HYDRO_PUMP, THUNDER, EARTHQUAKE, RECOVER
	db 55, VAPOREON,   SCOPE_LENS, HYDRO_PUMP, GROWTH, BLIZZARD, RECOVER
	dB 57, SUICUNE,    SCOPE_LENS, HYDRO_PUMP, REST, BLIZZARD, SLEEP_TALK
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 52, RAICHU,     THUNDER_WAVE, SURF, IRON_TAIL, THUNDER
	db 51, LANTURN,    HYDRO_PUMP, BLIZZARD, THUNDER, RECOVER
	db 52, RAIKOU,     THUNDER, HIDDEN_POWER, REST, SLEEP_TALK
	db 54, ELECTABUZZ, THUNDER, CROSS_CHOP, ICE_PUNCH, PSYCHIC_M
	db 54, AMPHAROS,   THUNDER, ICE_PUNCH, REST, SLEEP_TALK
	db 54, ZAPDOS,     THUNDER, HIDDEN_POWER, THUNDER_WAVE, ROOST
	db -1 ; end
...
ErikaGroup:
	...
	db 60, JUMPLUFF,   SLEEP_POWDER, LEECH_SEED, FLY, GIGA_DRAIN
	db 59, MEGANIUM,   ANCIENTPOWER, EARTHQUAKE, BODY_SLAM, GIGA_DRAIN
	db 59, VICTREEBEL, SLEEP_POWDER, SWORDS_DANCE, SLUDGE_BOMB, GIGA_DRAIN
	db 59, BELLOSSOM,  LEECH_LIFE, SYNTHESIS, HIDDEN_POWER, GIGA_DRAIN
	db 59, SUNFLORA,   SLEEP_POWDER, GROWTH, HIDDEN_POWER, GIGA_DRAIN
	db 59, CELEBI,     PSYCHIC_M, GIGA_DRAIN, RECOVER, ANCIENTPOWER
	db -1 ; end
...
JanineGroup:
	...
	db 65, GENGAR, 	   HYPNOSIS, ICE_PUNCH, THUNDER, STRENGTH
	db 65, NIDOKING,   LOVELY_KISS, EARTHQUAKE, BLIZZARD, THUNDER
	db 65, CROBAT,     SCREECH, SLUDGE_BOMB, ROOST, FLY
	db 64, WEEZING,    FIRE_BLAST, SLUDGE_BOMB, THUNDER, EXPLOSION
	db 64, MUK,	   FIRE_BLAST, SLUDGE_BOMB, GIGA_DRAIN, EXPLOSION
	db 65, NIDOQUEEN,  LOVELY_KISS, EARTHQUAKE, BLIZZARD, THUNDER
	db -1 ; end
...
SabrinaGroup:
	...
	db 54, JYNX,      LOVELY_KISS, PSYCHIC_M, BLIZZARD, THIEF
	db 54, STARMIE,   HYDRO_PUMP, THUNDER, BLIZZARD, RECOVER
	db 55, ALAKAZAM,  RECOVER, DYNAMICPUNCH, PSYCHIC_M, FIRE_PUNCH
	db 55, EXEGGUTOR, PSYCHIC_M, GIGA_DRAIN, SLEEP_POWDER, EXPLOSION
	db 55, MEW,       PSYCHIC_M, STRENGTH, HIDDEN_POWER, SOFTBOILED
	db 56, MEWTWO,    PSYCHIC_M, FIRE_BLAST, HIDDEN_POWER, RECOVER
	db -1 ; end
...
Rival2Group:
	...
	db 44, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 44, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 45, MEGANIUM,   EARTHQUAKE, GIGA_DRAIN, SWORDS_DANCE, BODY_SLAM
	db -1 ; end
	...
	db 44, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 44, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 45, TYPHLOSION, FIRE_BLAST, EARTHQUAKE, THUNDERPUNCH, STRENGTH
	db -1 ; end
	...
	db 44, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 44, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 45, FERALIGATR, HYDRO_PUMP, BLIZZARD, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
	...
	db 67, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 68, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 70, MEGANIUM,   EARTHQUAKE, GIGA_DRAIN, SWORDS_DANCE, BODY_SLAM
	db -1 ; end
	...
	db 67, GENGAR,     HYPNOSIS, THUNDER, ICE_PUNCH, DESTINY_BOND
	db 68, UMBREON,    TOXIC, CHARM, FAINT_ATTACK, MOONLIGHT
	db 70, FERALIGATR, HYDRO_PUMP, CURSE, EARTHQUAKE, ROCK_SLIDE
	db -1 ; end
...
HikerGroup:
	...
	db 36, QUAGSIRE,   LEFTOVERS,    BODY_SLAM, EARTHQUAKE, RECOVER, STRENGTH
	db 35, MAROWAK,	   THICK_CLUB,   SWORDS_DANCE, EARTHQUAKE, ROCK_SLIDE, BODY_SLAM
	db 36, SANDSLASH,  LEFTOVERS,    SWORDS_DANCE, EARTHQUAKE, ROCK_SLIDE, STRENGTH
	db 37, RHYDON,	   QUICK_CLAW,   ROCK_SLIDE, EARTHQUAKE, ZAP_CANNON, STRENGTH
	db 35, GOLEM,      FOCUS_BAND,   ROCK_SLIDE, EARTHQUAKE, STRENGTH, FIRE_BLAST
	db 35, TYRANITAR,  BRIGHTPOWDER, ROCK_SLIDE, EARTHQUAKE, STRENGTH, THUNDERBOLT
	db -1 ; end
...
BlaineGroup:
	...
	db 67, HOUNDOOM,   FIRE_BLAST, CRUNCH, HIDDEN_POWER, SUNNY_DAY
	db 68, ARCANINE,   IRON_TAIL, HIDDEN_POWER, FIRE_BLAST, CRUNCH
	db 69, CHARIZARD,  FIRE_BLAST, EARTHQUAKE, ROCK_SLIDE, FLY
	db 71, ENTEI,      FIRE_BLAST, SUNNY_DAY, SOLARBEAM, IRON_TAIL
	db 73, MOLTRES,    SUNNY_DAY, FIRE_BLAST, SOLARBEAM, ROOST
	db 74, HO_OH,      SACRED_FIRE, THUNDER, GIGA_DRAIN, RECOVER
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 32, HOUNDOOM,   FIRE_BLAST, HIDDEN_POWER, PURSUIT, STRENGTH
	...
	db 31, GRANBULL,   FRUSTRATION, EARTHQUAKE, LOVELY_KISS, SURF
	db 32, GIRAFARIG,  PSYCHIC_M, EARTHQUAKE, FRUSTRATION, THUNDER
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 36, CROBAT,     ROOST, CRUNCH, CONFUSE_RAY, FLY
	db -1 ; end
	...
	db 31, GENGAR,     ICE_PUNCH, THUNDER, HYPNOSIS, CRUNCH
	db 32, SANDSLASH,  DIG, ROCK_SMASH, STRENGTH, SWORDS_DANCE
	db -1 ; end
...
RedGroup:
	...
	db 100, MEWTWO,     LEFTOVERS, PSYCHIC_M, FIRE_BLAST, SHADOW_BALL, RECOVER
	db 100, ZAPDOS,     LEFTOVERS, THUNDER, HIDDEN_POWER, DRILL_PECK, ROOST
	db 100, SCIZOR,     LEFTOVERS, LEECH_LIFE, METAL_CLAW, SWORDS_DANCE, ROOST
	db 100, TYRANITAR,  LEFTOVERS, ROCK_SLIDE, EARTHQUAKE, CURSE, REST
	dB 100, VAPOREON,   LEFTOVERS, HYDRO_PUMP, BLIZZARD, GROWTH, RECOVER
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 75, LUGIA,      THUNDER, EARTHQUAKE, HYDRO_PUMP, RECOVER
	db 75, MEWTWO,     FIRE_BLAST, SHADOW_BALL, PSYCHIC_M, RECOVER
	db 73, TYRANITAR,  ROCK_SLIDE, EARTHQUAKE, CURSE, REST
	db 74, SNORLAX,    DOUBLE_EDGE, CURSE, EARTHQUAKE, REST
	db 73, LAPRAS,     BLIZZARD, THUNDER, REST, SLEEP_TALK
	db 75, ZAPDOS,     THUNDER, HIDDEN_POWER, THUNDER_WAVE, ROOST
	db -1 ; end
