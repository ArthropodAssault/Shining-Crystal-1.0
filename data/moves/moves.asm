...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move CUT,          EFFECT_POISON_HIT,         70, BUG,          100, 30,  30
	...
	move FLY,          EFFECT_FLINCH_HIT,         95, FLYING,       100, 15,  10
	...
	move POISON_STING, EFFECT_POISON_HIT,         35, POISON,       100, 35,  50
	...
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,           90,  5,  10
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         80, FIGHTING,     100, 20,   0
	...
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,        90, 40,   0
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         90, ROCK,         100, 20,  20
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,       100, 25, 100
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      80, STEEL,         95, 15,  30
	move VITAL_THROW,  EFFECT_ALWAYS_HIT,         70, FIGHTING,     100, 10,   0
	move MORNING_SUN,  EFFECT_HEAL,                0, NORMAL,       100,  5,   0
	move SYNTHESIS,    EFFECT_HEAL,                0, GRASS,        100,  5,   0
	...
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       80, NORMAL,       100, 15,   0
	...
	move ROCK_SMASH,   EFFECT_ATTACK_UP_HIT,      75, ROCK,         100, 15,  30
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,         70, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,         100, 10,   0
	move ROOST, 	   EFFECT_HEAL,		       0, FLYING,       100, 10,   0
